...
Eigen::Matrix2d get_uv_error(State2D box)
{
    ...
    double v_error = 0.05 * box.height;
    if (u_error > 13) 
        u_error = 13;
    else if (u_error < 2) 
        u_error - 2;
...
{ 
    ...
    // Eigen::Vector3d T(0.015017, 0.00491425, -0.0307327);
    // Eigen::Quaterniond Q(-0.422208, 0.566499, -0.540677, 0.456605);
    // Eigen::Vector3d T(0.015017, 0.00491425, -0.0307327);
    // Eigen::Quaterniond Q(-0.422208, 0.566499, -0.540677, 0.456605);
    // Eigen::Vector3d T(0.0165536, 0.00518321, -0.032887);
    // Eigen::Quaterniond Q(-0.421641, 0.565062, -0.538769, 0.461142);
